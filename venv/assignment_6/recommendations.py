# original code downloaded from https://github.com/arthur-e/Programming-Collective-Intelligence/blob/master/chapter2/recommendations.py
# editied for web science assignment 6 by Mack Kerchner
#!/usr/bin/python
# -*- coding: utf-8 -*-
